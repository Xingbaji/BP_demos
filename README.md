...
这是面向投资人的代表性研究成果索引。页面以论文 / 文章为主体，直接说明正式题名、发表状态、团队角色、主要工作与代表性结果；公开视频只是辅助理解材料，不是页面主体。

## 当前结构

- 单页叙事：首页定位 → 六项研究成果 → 能力覆盖 → 页面说明。
- 成果优先：无需打开播放器即可阅读每项工作的完整题名、主要工作、团队角色和论文 / 项目入口。
...
- 每项成果都可通过播放器中的“复制该成果链接”生成独立分享地址。
