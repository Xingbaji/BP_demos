...
这是面向投资人的核心团队代表性研究页面。页面依据融资 BP 的技术主线组织，以公开视频为主要入口，说明各项公开工作如何共同支撑“现实理解 → 复杂物理 → 规模化数据 → 模型与真机 → 真实评测”的能力闭环。

## 当前结构

- 单页结构：核心命题 → 能力闭环 → 关键公开证据 → 八项工作 Demo → 归属说明。
- Demo 优先：点击首页代表工作或任意卡片画面即可播放官方 MP4 / YouTube；论文与项目主页保留为核验入口。
